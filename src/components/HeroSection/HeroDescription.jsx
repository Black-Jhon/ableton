    ...
    <div data-aos="fade-up" data-aos-duration="3000" className="lg:my-40 my-10">
      <div className="flex justify-center">
        <h1
          ...
          We make <span className="text-[#0851FF] cursor-pointer">Live</span>, <span
          className="text-[#0851FF] cursor-pointer">Push</span> and{" "}
          <span className="text-[#0851FF] cursor-pointer">Link</span> — unique software and hardware for music creation
          and performance. With these products, our community of users creates amazing
          things.
        </h1>
      </div>
