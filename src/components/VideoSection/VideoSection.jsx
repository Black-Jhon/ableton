    ...
    <div className="grid justify-center">
      <div>
        <div className="flex justify-center mt-10">
          <h1 className="lg:w-[50rem] md:w-40 w-80 lg:text-xl text-lg tracking-wider leading-loose font-bold font-mono">
            Making music isn’t easy. It takes time, effort, and learning. But when you’re in the flow, it’s incredibly rewarding.
          </h1>
        </div>

        <p className="lg:w-[50rem] md:w-40 w-80 flex m-auto mt-5 font-thin leading-loose tracking-wider">
